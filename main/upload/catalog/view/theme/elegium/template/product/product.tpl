...
<div id="content">
  ...
  <div class="product-info">
    ...
    <div class="left">
      ...
      <div class="zoom"><a id="zoomer" class="colorbox" href="<?php echo $popup; ?>"><?php echo $this->language->get('theme_zoom'); ?></a></div>
      </div>
      <?php } ?>
      <?php if ($images) { ?>
      <div class="image-additional">
        <?php foreach ($images as $image) { ?>
        <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo $image['thumb']; ?>' "><img src="<?php echo $image['thumb']; ?>" width="90" height="90" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
        <?php } ?>
      </div>
      <?php } ?>
    </div>
     ...
     <h1><?php echo $heading_title; ?></h1>
      ...
      <div class="options">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <input type="hidden" name="option[<?php echo $option['product_option_id']; ?>]" value="" /><br /><br />
        </div>
        <br />
        <?php } ?>
      ...
      <div class="review">
        <div><img src="catalog/view/theme/elegium/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /><br />
      ...
      <?php } else { ?>
      <div class="review">
      	<img id="rating-none" src="catalog/view/theme/elegium/image/stars-0.png" alt="<?php echo $reviews; ?>" /><br />
        <div class="share"><!-- AddThis Button BEGIN -->
          <div class="addthis_default_style"><a class="addthis_button_compact"><?php echo $text_share; ?></a> <a class="addthis_button_email"></a><a class="addthis_button_print"></a> <a class="addthis_button_facebook"></a> <a class="addthis_button_twitter"></a></div>
          <script type="text/javascript" src="//s7.addthis.com/js/250/addthis_widget.js"></script> 
          <!-- AddThis Button END --> 
